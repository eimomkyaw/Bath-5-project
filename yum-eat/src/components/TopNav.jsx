  ...
  return (
    <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
      ...
      <div className="bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[300px] lg:w-[500px]">
        ...
        <input
          type="text"
          className="bg-transparent p-2 w-full focus:outline-none placeholder:search meals"
        />
      </div>
      ...
      {sideNav ? (
        <div className="bg-black-60 fixed w-full h-screen z-10 top-0" onClick={() => setSideNav(!sideNav)}>
